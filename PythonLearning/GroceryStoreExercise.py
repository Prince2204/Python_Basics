...
In a .py file, write a program which calculates the subtotal of 
all 6 of these items using an expression.  
...
baguettes=3.00
meatballs=4.39
total=penne+arrabiata+garlicCloves+italianSeasoning+baguettes+meatballs
